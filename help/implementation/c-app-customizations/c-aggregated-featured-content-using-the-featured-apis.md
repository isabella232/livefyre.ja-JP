---
description: Livefyreは4つの特集APIを提供し、入力ネットワーク、サイト、コレクション、または入力コレクションの上部にある2つの特集コンテンツの最新50個の項目を取得できます。
seo-description: Livefyreは4つの特集APIを提供し、入力ネットワーク、サイト、コレクション、または入力コレクションの上部にある2つの特集コンテンツの最新50個の項目を取得できます。
seo-title: 重点APIを使用した集計された重点コンテンツ
solution: Experience Manager
title: 重点APIを使用した集計された重点コンテンツ
...
# 重点APIを使用した集計された重点コンテンツ{#aggregated-featured-content-using-the-featured-apis}

Livefyreは4つの特集APIを提供し、入力ネットワーク、サイト、コレクション、または入力コレクションの上部にある2つの特集コンテンツの最新50個の項目を取得できます。

## 重点（ネットワーク） {#section_cgm_1nw_xz}

入力ネットワークに対して、最新50個の重点コンテンツ（およびその発言者）を取得します。 （ページングを使用して、最新の50件のみでなく、すべてのコンテンツを返します）。
...
入力サイトに対して、最新50個の特集コンテンツ（およびその発言者）を返します。 （ページングを使用して、最新の50件のみでなく、すべてのコンテンツを返します）。
...
## おすすめ（コレクション） {#section_kgc_xmw_xz}

入力コレクションに対して、最新50個の特集コンテンツ（およびその発言者）を返します。 （ページングを使用して、最新の50件のみでなく、すべてのコンテンツを返します）。
...
## 特集（ヘッド） {#section_n4b_lmw_xz}

入力コレクションに対して、最近2つの特集コンテンツを返します。
