...
+ [Livefyre End-of-Service Reminder](c-anouncements.md)
+ [Livefyre ヘルプ](home.md)
+ [トレーニングビデオにアクセス](c-access-training-videos.md)
...
+ アプリ{#apps}
   ...
   + マップ {#map}
      ...
      + [マップフィーチャ](c-about-apps/c-map-app/r-map-features.md)
      + [カスタマイズをマッピング](c-about-apps/c-map-app/r-map-customizations.md)
   + Media Wall {#mediawall}
      + [Media Wall](c-about-apps/c-media-wall-app/c-media-wall-app.md)
      + [Media Wall の機能](c-about-apps/c-media-wall-app/r-media-wall-features.md)
   ...
   + モザイク {#mosaic}
      ...
      + [モザイク機能](c-about-apps/c-mosaic-app/r-mosaic-features.md)
      + [モザイクのカスタマイズ](c-about-apps/c-mosaic-app/c-mosaic-customizations.md)
   + 投票 {#polls}
      + [投票](c-about-apps/c-polls-app/c-polls-app.md)
      + [コメントまたはライブブログアプリに投票を追加する](c-about-apps/c-polls-app/t-integrate-poll-site.md)
      + [投票に画像を追加する](c-about-apps/c-polls-app/t-add-images-to-a-poll.md)
      + [集計のカスタマイズ](c-about-apps/c-polls-app/r-polls-customizations.md)
   + レビュー {#reviews}
   ...
   + Sidenotes {#sidenotes}
      ...
      + [Sidenotes 機能](c-about-apps/c-sidenotes-app/r-sidenotes-features.md)
      + [Sidenotes カスタマイズ](c-about-apps/c-sidenotes-app/r-sidenotes-customizations.md)
      + [Sidenotes のベストプラクティス](c-about-apps/c-sidenotes-app/c-best-practices-for-sidenotes.md)
   + Storify 2 {#storify2}
      + [Storify 2](c-about-apps/c-storify2/c-storify2.md)
      + [設定オプション](c-about-apps/c-storify2/c-configuration-options.md)
      + [設定を保存](c-about-apps/c-storify2/c-storify-settings.md)
      + [Storify 2 でのGoogle AMP の使用](c-about-apps/c-storify2/t-use-google-amp-with-storify-2.md)
      + [ストーリーを作成](c-about-apps/c-storify2/t-create-a-story.md)
      + [ソーシャルコンテンツを追加](c-about-apps/c-storify2/t-add-social-content.md)
      + [テキストを追加](c-about-apps/c-storify2/t-add-local-content.md)
      + [ストーリーのプレビュー](c-about-apps/c-storify2/t-preview-a-story.md)
      + [ストーリーの公開](c-about-apps/c-storify2/t-publish-a-story.md)
      + [レビュー履歴](c-about-apps/c-storify2/t-review-storify2-history.md)
      + [同じストーリーで複数のエディターを操作](c-about-apps/c-storify2/t-working-with-multiple-editors-on-same-story.md)
      + [ストリームを使用したストーリーへのソーシャルコンテンツの追加](c-about-apps/c-storify2/t-use-streams-to-add-social-content.md)
      + [投稿を Storify に固定する 2](c-about-apps/c-storify2/t-pin-posts-to-storify2.md)
      + ナビゲーションガイド {#navigation-guide}
         + [ナビゲーションガイド](c-about-apps/c-storify2/c-navigation-guide.md)
         + [Storify 2 にナビゲーションガイドを追加する](c-about-apps/c-storify2/t-add-navigation-guide-to-storify2.md)
         ...
         + [ナビゲーションガイドの固定](c-about-apps/c-storify2/t-make-nav-guide-sticky.md)
...
+ アプリの機能 {#app-features}
   ...
   + [カスタムコールトゥアクションボタン](c-features-livefyre/c-call-to-action-button.md)
   ...
   + コレクションおよびコンテンツのタグ {#collection-content-tags}
      + [コレクションおよびコンテンツのタグ](c-features-livefyre/c-content-collection-tags/c-content-collection-tags.md)
      + [コレクションを変更](c-features-livefyre/c-content-collection-tags/c-change-collection.md)
      + [コレクションまたはコンテンツタグで検索をフィルタリング](c-features-livefyre/c-content-collection-tags/t-filter-search-by-tag.md)
      + [コンテンツタグで検索をフィルタリング](c-features-livefyre/c-content-collection-tags/t-filter-search-by-content-tag.md)
      + [Embedly 統合](c-features-livefyre/c-content-collection-tags/c-embedly-integration.md)
      + [おすすめコンテンツ](c-features-livefyre/c-content-collection-tags/c-featured-content.md)
      + [機能コンテンツ](c-features-livefyre/c-content-collection-tags/t-feature-content.md)
      + [Studio から機能するコンテンツを選択](c-features-livefyre/c-content-collection-tags/t-select-content-to-feature-from-studio.md)
      + [アプリから機能するコンテンツを選択](c-features-livefyre/c-content-collection-tags/t-select-content-to-feature.md)
      + [Studio でのコンテンツ機能の有効化](c-features-livefyre/c-content-collection-tags/t-enable-featuring-content-in-studio.md)
      + [固定リンク](c-features-livefyre/c-content-collection-tags/c-permalinks.md)
   + カスタム HTML {#custom-html}
      ...
      + [コメントに投票を埋め込む](c-features-livefyre/c-custom-html/t-embed-polls-in-comments.md)
      + [Studio でカスタムHTMLコメントを表示](c-features-livefyre/c-custom-html/t-view-custom-html-comments-in-studio.md)
   + [管理機能](c-features-livefyre/c-enagement-features.md)
   ...
   + モデレートとフィルター {#moderation-filtering}
      ...
      + [twitterユーザーからのコンテンツの制限](c-features-livefyre/c-about-moderation/t-moderate-streams.md)
      + [IP アドレスの禁止](c-features-livefyre/c-about-moderation/t-set-up-bans.md)
      + [不敬虔性フィルターの使用](c-features-livefyre/c-about-moderation/c-profanity-filter.md)
      + [ユーザーをモデレート](c-features-livefyre/c-about-moderation/t-moderate-users-modq.md)
      + [ModQ を使用してコンテンツをモデレート](c-features-livefyre/c-about-moderation/c-modq.md)
      + [ごみ箱に入れた項目をアプリに追加し直す](c-features-livefyre/c-about-moderation/t-add-trashed-item-back-into-app.md)
   ...
   + 通知機能 {#notifications-features}
      ...
      + [ネットワークメールの設定](c-features-livefyre/c-notifications-features/t-set-up-network-email.md)
   ...
   + スタイル設定機能 {#styling-features}
      ...
      + [埋め込みメディアを管理](c-features-livefyre/c-styling-features/c-manage-embedded-media.md)
   ...
   + [UGC コマース](c-features-livefyre/c-ugc-commerce.md)
   + [UGC をキュレーションおよび表示](c-features-livefyre/curate-display-ugc.md)
   + [製品 ID で UGC をフィルタリング](c-features-livefyre/filter-ugc-product-id.md)
+ ライブラリ {#library}
   + アセット{#assets}
      + [Assets](c-library/c-assets/c-assets.md)
      + [アセットフォルダーの作成](c-library/c-assets/t-create-folders.md)
      + [アセットフォルダーを管理](c-library/c-assets/t-manage-folders.md)
      + [アセットの詳細を表示](c-library/c-assets/t-manage-assets.md)
      + [アプリへのアセットの公開](c-library/c-assets/t-publish-assets-to-apps.md)
   ...
   + [URL で検索](c-library/c-searching-for-content.md)
   + [YouTube Content を検索](c-library/t-search-for-youtube-content.md)
   + [twitter Content を検索](c-streams/c-youtube-rules/t-search-for-twitter-content.md)
   + [instagram Content を検索](c-library/t-search-for-content.md)
   + [コンテンツの詳細を表示](c-library/c-view-content-details.md)
   ...
   + [Hootsuite でのAdobe Experience Manager Livefyre の使用](c-library/c-hootsuite-livefyre.md)
   + [Adobe TargetでのAdobe Experience Manager Livefyre の使用](c-library/livefyre-target.md)
   + [AdobeLaunch Livefyre 拡張機能を使用する](c-library/launch-extension.md)
+ ストリーム {#streams}
   + [ストリーム](c-streams/c-streams.md)
   + [新しいストリームの作成](c-streams/t-create-a-new-stream.md)
   + [ストリームにルールを追加](c-streams/t-add-rules-for-your-stream.md)
   ...
   + [メールルール](c-streams/c-email-rules.md)
   ...
   + [Tumblr ルール](c-streams/c-tumblr-rules.md)
   + [Twitter Rules](c-streams/c-twitter-rules.md)
   + [ツイートのスロットルと頻度](c-streams/c-throttling-and-frequency-of-tweets.md)
   + [YouTube Rules](c-streams/c-youtube-rules/c-youtube-rules.md)
+ 権限リクエスト {#rights-requests}
   + [権限のリクエスト](c-how-requesting-rights-works/c-how-requesting-rights-works.md)
   ...
   + [twitter Rights リクエストの送信](c-how-requesting-rights-works/t-send-a-rights-request-to-own-a-digital-asset.md)
   + [部分的に自動化されたInstagram Rights Request の送信](c-how-requesting-rights-works/c-send-an-instagram-rights-request-from-the-library.md)
   + [instagram Rights リクエストを手動で送信](c-how-requesting-rights-works/c-send-instagram-manual-rights-request.md)
   + [権限アクティビティ履歴を表示](c-how-requesting-rights-works/c-view-rights-activity-history.md)
   + [アセットライブラリからの保留中の権限リクエストを使用してコンテンツを管理](c-how-requesting-rights-works/t-manage-content-with-pending-rights-request.md)
   + [アセットライブラリからのアセットの権限の手動による許可または取り消し](c-how-requesting-rights-works/t-manually-grant-the-rights-for-one-or-more-assets.md)
+ ユーザー：Studio と Livefyre ネットワークユーザーの管理 {#users-managing}
   + [ユーザー：Studio と Livefyre ネットワークユーザーの管理](c-users/c-users.md)
   + [ユーザーの検索](c-users/t-search-for-users.md)
   + [アカウントの詳細の表示](c-users/c-viewing-account-details.md)
   + [ユーザーの禁止](c-users/t-ban-a-user.md)
   + [ユーザーの許可リストへの登録](c-users/allow-list-a-user.md)
   + [ユーザーアカウントをリンク](c-users/t-link-user-accounts.md)
   + [ネットワークを切り替えるユーザ](c-users/c-users-switching-networks.md)
...
+ ユーザー：ユーザーアカウントの作成 {#users-creating-accounts}
   ...
   + [ユーザーを招待して Studio アカウントを作成する](c-users-creating-accounts-with-studio-access/t-invite-a-user-to-create-a-studio-account.md)
   + [Studio アカウントを作成するための招待を受け入れる](c-users-creating-accounts-with-studio-access/t-accept-an-invitation-to-create-a-studio-account.md)
   + [Studio にログイン](c-users-creating-accounts-with-studio-access/t-log-into-studio.md)
   + [ユーザーの Studio 権限を管理](c-users-creating-accounts-with-studio-access/t-manage-studio-permissions-for-users.md)
   + [ユーザーの役割と権限](c-users-creating-accounts-with-studio-access/c-user-types.md)
   + Social アカウントの追加 {#add-social-account}
      + [Social アカウントの追加](c-users-creating-accounts-with-studio-access/t-configure-social-accout-instagram/t-configure-social-accout-instagram.md)
      + [instagram Accounts について](c-users-creating-accounts-with-studio-access/t-configure-social-accout-instagram/c-about-instagram-accounts.md)
...
+ 設定：その他 {#settings-other}
   ...
   + [ネットワークにサイトを追加する](c-settings-other/t-add-a-site.md)
   + 翻訳セット {#translation-sets}
      ...
      + [文字列をローカライズ](c-settings-other/c-translation-sets/c-localize-strings.md)
      + [テキスト文字列を確認](c-settings-other/c-translation-sets/c-review-text-strings.md)
      + [Sidenotes テキスト文字列](c-settings-other/c-translation-sets/c-sidenotes-text-strings.md)
   + SSL の適用 {#ssl-enforcement}
      + [SSL の適用](c-settings-other/c-ssl-enforcement/c-ssl-enforcement.md)
      + [SSL チェックリスト](c-settings-other/c-ssl-enforcement/c-ssl-checklist.md)
   + プライバシーリクエスト {#privacy-requests}
      + [プライバシーリクエスト（GDPR 対応）](c-settings-other/c-gdpr-compliance/c-gdpr-compliance.md)
      + [プライバシーリクエストに関する FAQ](c-settings-other/c-gdpr-compliance/c-privacy-request-faqs.md)
...
+ リリースノート {#release-notes}
   ...
   + リリースノート 2019 {#rn2019}
      ...
      + [2019 年 2 月 22 日](c-rn/previous-rns/rn2019/c-rn-2019-february-21.md)
   ...
   + リリースノート 2018 {#rn2018}
      ...
      + [2018 年 11 月 16 日](c-rn/previous-rns/rn2018/c-rn-2018-november-15.md)
      ...
      + [2018 年 9 月 7 日](c-rn/previous-rns/rn2018/c-rn-2018-september-6.md)
      + [2018 年 8 月 24 日](c-rn/previous-rns/rn2018/c-rn-2018-august-23.md)
      ...
      + [2018 年 5 月 18 日](c-rn/previous-rns/rn2018/c-rn-2018-may-17.md)
      ...
      + [2018 年 1 月 19 日](c-rn/previous-rns/rn2018/c-rn-2018-january-18.md)
   + リリースノート 2017 {#rn2017}
      + [2017 年 11 月 17 日](c-rn/previous-rns/rn2017/c-rn-2017-november-16.md)
      + [2017 年 11 月 3 日](c-rn/previous-rns/rn2017/c-rn-2017-november-2.md)
      + [2017 年 10 月 20 日](c-rn/previous-rns/rn2017/c-rn-2017-october-19.md)
      ...
      + [2017 年 9 月 15 日](c-rn/previous-rns/rn2017/c-2017-september-14.md)
      ...
      + [2017 年 6 月 30 日](c-rn/previous-rns/rn2017/c-rn-2017-june-29.md)
      + [2017 年 6 月 16 日](c-rn/previous-rns/rn2017/c-rn-2017-june-15.md)
      + [2017 年 6 月 2日](c-rn/previous-rns/rn2017/c-rn-2017-june-1.md)
      + [2017 年 5 月 19 日](c-rn/previous-rns/rn2017/c-rn-2017-may-18.md)
      ...
      + [2017 年 2 月 24 日](c-rn/previous-rns/rn2017/c-rn-2017-february-23.md)
      + [2017 年 2 月 10 日](c-rn/previous-rns/rn2017/c-rn-2017-february-9.md)
      + [2017 年 1 月 27 日](c-rn/previous-rns/rn2017/c-rn-2017-january-26.md)
      + [2017 年 1 月 13 日](c-rn/previous-rns/rn2017/c-rn-2017-january-12.md)
